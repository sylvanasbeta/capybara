...
Capybara.register_server :puma do |app, port, host, **options|
  begin
    ...
    raise LoadError, "Capybara is unable to load `puma` for its server, please add `puma` to your project or select a different server via something like `Capybara.server = :webrick` etc."
  end
